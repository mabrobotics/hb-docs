...
Configuration of the Honey Badger robot can be extended by mounting additional payload to its back. It allows user for upgrading Honey Badger capabilities.
