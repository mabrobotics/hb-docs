...
- For the AP name, password, and wired connection options, see `GettingStarted/Setup.md`.
...
For full safety guidance, see `GettingStarted/Safety.md`.
...
## Next steps / Links
- For full setup and charging procedures see `GettingStarted/Setup.md`.
- For detailed control console usage see `GettingStarted/ControlConsole.md`.
- For safety and emergency procedures see `GettingStarted/Safety.md`.
