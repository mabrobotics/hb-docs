...
This page describes package contents, robot network setup, and charging. For the step-by-step startup sequence, follow `GettingStarted/FirstStartup.md` and `GettingStarted/Safety.md`.
...
For Steam Deck setup and controller-specific connection guidance, see `GettingStarted/ControlConsole.md`.
...
For detailed startup, stand-up, and shutdown guidance, use `GettingStarted/FirstStartup.md`.
